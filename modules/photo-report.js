...
function showMtInstallForm() {
        ...
        <div class="mt-install-form-container">
            ...
            <div class="form-section">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-input" id="mt-skzi-number" 
                           placeholder="Номер СКЗИ" 
                           value="${appState.mtInstallData.skziNumber || ''}">
                </div>
            </div>
    ...
    document.getElementById('continue-to-photos-btn').addEventListener('click', () => {
        ...
        appState.mtInstallData = {
            ...
            skziNumber: document.getElementById('mt-skzi-number').value.trim(),
            photoTypes: {
        ...
        <div class="photo-upload-container">
            ...
            <div class="form-section">
                ...
                <div class="summary-item">
                    ...
                    <div class="summary-value">${appState.mtInstallData.skziNumber}</div>
                </div>
            </div>
...
function updatePhotoPreview() {
    ...
    const remainingPhotos = 20 - appState.photos.length; // Для простой диагностики максимум 20
